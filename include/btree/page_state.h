...
#define PAGE_STATE_HAS_WAITERS_FLAG	(1U << 18)
#define PAGE_STATE_LIST_LOCKED_FLAG	(1U << 19)
#define PAGE_STATE_LOCKED_FLAG	(1U << 20)
#define PAGE_STATE_NO_READ_FLAG	(1U << 21)
#define PAGE_STATE_CHANGE_COUNT_ONE	(1U << 22)
#define PAGE_STATE_CHANGE_COUNT_MASK (0xFFC00000)
#define PAGE_STATE_CHANGE_NON_WAITERS_MASK (0xFFF80000)
